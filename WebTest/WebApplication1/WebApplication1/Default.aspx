...
<head runat="server">
    ...
    <script language="javascript">
        ...
        function GetExt() {
            var fileName = document.all("txtFileName").value;

            var ext = fileName.split('.').pop();
            if (ext == fileName) alert('');
            alert(ext);
    ...
    <form id="form1" runat="server">
        <div>
            ...
            <table id="table1" width="100%" border="1px">
                <tr>
                    <td>&nbsp;<asp:Button ID="Button3" runat="server" Text="AddCookie" /></td>
                    <td>&nbsp;<asp:Button ID="Button4" runat="server" Text="ClearCookie" /></td>
                </tr>
                <tr>
                    <td>
        ...
        <p>
            ...
            <asp:Button ID="Button11" runat="server" OnClick="Button11_Click" Text="空日期" />
            <p>
                ...
                <input name="txtFileName" type="text" id="txtFileName" />
                <asp:Button ID="Button10" runat="server" Text="btnGetExt" OnClientClick="GetExt();" />
            </p>
            <p>
                 <asp:TextBox ID="txtAmount" runat="server">1374684</asp:TextBox>
                 <asp:TextBox ID="txtRate" runat="server">3</asp:TextBox>
                <asp:TextBox ID="txtLowerLimit" runat="server">4414</asp:TextBox>
                <asp:TextBox ID="txtHigherLimit" runat="server">5000</asp:TextBox>
                 <asp:TextBox ID="txtRate1" runat="server">49</asp:TextBox>
                <asp:TextBox ID="txtRate2" runat="server">40</asp:TextBox>
                <asp:TextBox ID="txtRate3" runat="server">11</asp:TextBox>
                 <asp:Button ID="btnCalBrokerage" runat="server" Text="计算佣金" OnClick="btnCalBrokerage_Click" />
                     <asp:TextBox ID="txtBrokerage" runat="server"></asp:TextBox>
                 <asp:TextBox ID="txtBrokerage1" runat="server"></asp:TextBox>
                <asp:TextBox ID="txtBrokerage2" runat="server"></asp:TextBox>
                <asp:TextBox ID="txtBrokerage3" runat="server"></asp:TextBox>
            </p>
    </form>
