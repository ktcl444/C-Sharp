<%@ Control Language="vb" AutoEventWireup="false" Codebehind="LogonControl.ascx.vb" Inherits="AppDevASPExtranet.Contoso.Web.UI.WebControls.LogonControl" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
