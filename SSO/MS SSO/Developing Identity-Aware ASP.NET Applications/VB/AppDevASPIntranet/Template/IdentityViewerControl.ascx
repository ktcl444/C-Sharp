<%@ Control Language="vb" AutoEventWireup="false" Codebehind="IdentityViewerControl.ascx.vb" Inherits="AppDevASPIntranet.Contoso.Web.UI.WebControls.IdentityViewerControl" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
