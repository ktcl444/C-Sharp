...
Namespace Contoso.AppDevASPSample
    ...
    ' <summary>
    '   Creates an AZMan policy file in C:\AppDevASPIntranet.xml for
    '   the Intranet sample. The file AzMan store, application,
    ...
    Public Class AzManInstaller
        ...
        Private Const AZ_POLICY_URL As String = "msxml://C:\AppDevASPIntranet.xml"
        Private Const APPLICATION_NAME As String = "AppDevASPIntranet"
        ...
        Private Sub CreateRoles(ByVal app As IAzApplication)
            ...
            Dim scope As IAzScope = Nothing

            Try
                scope = app.OpenScope("All", Nothing)
            Catch
                scope = app.CreateScope("All", Nothing)
