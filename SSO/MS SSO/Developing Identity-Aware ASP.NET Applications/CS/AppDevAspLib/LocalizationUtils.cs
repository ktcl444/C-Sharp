...
namespace Contoso.Web.UI.Localization
{
	...
	public class LocalizationUtils
	{
		...
		private string GetResourceString(System.Web.UI.Control genericControl, string attributeSuffix)
		{
			...
			try
			{
				theObject = resourceManager.GetObject(genericControl.ID + attributeSuffix);
			}
		...
		/// <summary>
		/// Get an assembly global resource string from an assembly
		...
		public static string GetGlobalString(string messageId)
		{
			...
			globalResourceManager = new ResourceManager(
				thisAssembly.GetName().Name + "." + thisAssembly.GetName().Name,  thisAssembly);
		...
		public void LocalizeControls(System.Web.UI.ControlCollection controls)
		{
			...
			foreach (System.Web.UI.Control genericControl in controls)
			{
				...
				{
					System.Web.UI.WebControls.AdRotator theControl = (System.Web.UI.WebControls.AdRotator)genericControl;
				...
				{
					System.Web.UI.WebControls.Button theControl = (System.Web.UI.WebControls.Button)genericControl;
					theControl.Text = GetResourceString(genericControl, ".Text");
					theControl.ToolTip = GetResourceString(genericControl, ".ToolTip");
				}
				else if (genericControl is System.Web.UI.WebControls.Calendar)
				{
					System.Web.UI.WebControls.Calendar theControl = (System.Web.UI.WebControls.Calendar)genericControl;
					theControl.ToolTip = GetResourceString(genericControl, ".ToolTip");
				}
				else if (genericControl is System.Web.UI.WebControls.CheckBox)
				{
					System.Web.UI.WebControls.CheckBox theControl = (System.Web.UI.WebControls.CheckBox)genericControl;
					theControl.Text = GetResourceString(genericControl, ".Text");
					theControl.ToolTip = GetResourceString(genericControl, ".ToolTip");
				}
				else if (genericControl is System.Web.UI.WebControls.CheckBoxList)
				{
					System.Web.UI.WebControls.CheckBoxList theControl = (System.Web.UI.WebControls.CheckBoxList)genericControl;
					i = 0;
				...
				{
					System.Web.UI.WebControls.DataGrid theControl = (System.Web.UI.WebControls.DataGrid)genericControl;
					theControl.ToolTip = GetResourceString(genericControl, ".ToolTip");
					foreach (System.Web.UI.WebControls.DataGridColumn dgCol in theControl.Columns)
					{
						System.Web.UI.WebControls.BoundColumn bCol = dgCol as System.Web.UI.WebControls.BoundColumn;
				...
				{
					System.Web.UI.WebControls.DropDownList theControl = (System.Web.UI.WebControls.DropDownList)genericControl;
					i = 0;
					foreach (System.Web.UI.WebControls.ListItem li in theControl.Items)
					{
						li.Text = GetResourceString(genericControl, "." + i.ToString() + ".Text");
				...
				{
					System.Web.UI.WebControls.Image theControl = (System.Web.UI.WebControls.Image)genericControl;
				...
				{
					System.Web.UI.WebControls.ImageButton theControl = (System.Web.UI.WebControls.ImageButton)genericControl;
					theControl.AlternateText = GetResourceString(genericControl, ".AlternateText");
					theControl.ImageUrl = GetResourceString(genericControl, ".ImageUrl");
					theControl.ToolTip = GetResourceString(genericControl, ".ToolTip");
				}
				...
				{
					System.Web.UI.WebControls.HyperLink theControl = (System.Web.UI.WebControls.HyperLink)genericControl;
					theControl.Text = GetResourceString(genericControl, ".Text");
					theControl.ToolTip = GetResourceString(genericControl, ".ToolTip");
				}
				else if (genericControl is System.Web.UI.WebControls.Label)
				{
					System.Web.UI.WebControls.Label theControl = (System.Web.UI.WebControls.Label)genericControl;
					theControl.Text = GetResourceString(genericControl, ".Text");
					theControl.ToolTip = GetResourceString(genericControl, ".ToolTip");
				}
				else if (genericControl is System.Web.UI.WebControls.ListBox)
				{
					System.Web.UI.WebControls.ListBox theControl = (System.Web.UI.WebControls.ListBox)genericControl;
					i = 0;
					foreach (System.Web.UI.WebControls.ListItem li in theControl.Items)
					{
						li.Text = GetResourceString(genericControl, "." + i.ToString() + ".Text");
				...
				{
					System.Web.UI.WebControls.Literal theControl = (System.Web.UI.WebControls.Literal)genericControl;
					theControl.Text = GetResourceString(genericControl, ".Text");
				}
				else if (genericControl is System.Web.UI.WebControls.LinkButton)
				{
					System.Web.UI.WebControls.LinkButton theControl = (System.Web.UI.WebControls.LinkButton)genericControl;
					theControl.Text = GetResourceString(genericControl, ".Text");
					theControl.ToolTip = GetResourceString(genericControl, ".ToolTip");
				}
				else if (genericControl is System.Web.UI.WebControls.RadioButton)
				{
					System.Web.UI.WebControls.RadioButton theControl = (System.Web.UI.WebControls.RadioButton)genericControl;
					theControl.Text = GetResourceString(genericControl, ".Text");
					theControl.ToolTip = GetResourceString(genericControl, ".ToolTip");
				}
				else if (genericControl is System.Web.UI.WebControls.RadioButtonList)
				{
					System.Web.UI.WebControls.RadioButtonList theControl = (System.Web.UI.WebControls.RadioButtonList)genericControl;
					i = 0;
					foreach (System.Web.UI.WebControls.ListItem li in theControl.Items)
					{
						li.Text = GetResourceString(genericControl, "." + i.ToString() + ".Text");
				...
				{
					System.Web.UI.WebControls.TextBox theControl = (System.Web.UI.WebControls.TextBox)genericControl;
					theControl.ToolTip = GetResourceString(genericControl, ".ToolTip");
				}
			}
		}
