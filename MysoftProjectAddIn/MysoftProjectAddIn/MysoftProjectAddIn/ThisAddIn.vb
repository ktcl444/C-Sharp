...
#End Region
    ...
    Private Sub EditItemButtonClick(ByVal ctrl As Office.CommandBarButton, ByRef cancel As Boolean)
        Try
            ...
            Dim fieldName() As String = {"text25", "text26", "text27", "text28", "text29", "text30"}
            Dim tableName As String = Application.GlobalTaskTables(1).Name
            For i = 0 To fieldName.Length - 1
                ...
                If Not isColumnExist Then
                    Application.TableEdit(Name:=tableName, TaskTable:=True, NewName:="", FieldName:="", NewFieldName:=fieldName(i), Title:="", Width:=10, Align:=2, ShowInMenu:=True, LockFirstColumn:=True, DateFormat:=255, RowHeight:=1, ColumnPosition:=-1, AlignTitle:=1)
